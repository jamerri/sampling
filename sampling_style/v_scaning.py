...
file_open_path = 'C:/Users/Lenovo/Desktop/采样数据集/v_interpolation_data.txt'
'''处理原始数据'''
...
np.savetxt("C:/Users/Lenovo/Desktop/采样数据集/v_scaning.txt", over_data,fmt='%5f',delimiter=',')
over_position_x = np.array(position_x)
over_position_y = np.array(position_y)
np.savetxt("C:/Users/Lenovo/Desktop/采样数据集/v_scaning_position.txt",(over_position_x,over_position_y),fmt='%5f',delimiter=',')
# print(position_x)
# # print(position_y)
# # print(m)
# # print(sampling_data)